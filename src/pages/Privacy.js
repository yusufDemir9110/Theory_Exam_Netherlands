...
const Privacy = () => {
  return (
    <div style={{ padding: "2rem" }}>
      <h1>Privacy Policy for Theory Exam Netherlands</h1>

      <p>
        At Theory Exam Netherlands, accessible from
        www.theoryExamNetherlands.com, one of our main priorities is the privacy
        of our visitors. This Privacy Policy document contains types of
        information that is collected and recorded by Theory Exam Netherlands
        and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in Theory Exam Netherlands. This policy is not
      ...
      <p>
        Theory Exam Netherlands follows a standard procedure of using log files.
      ...
      <p>
        ...
        advertising partners of Theory Exam Netherlands.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Theory Exam Netherlands, which
      ...
      <p>
        Note that Theory Exam Netherlands has no access to or control over these
      ...
      <p>
        Theory Exam Netherlands's Privacy Policy does not apply to other
      ...
      <p>
        Theory Exam Netherlands does not knowingly collect any Personal
